...
const dataRevision = 'score-2.2.0'
...
const comparisonRows = computed(() => {
  ...
  return [
    ...
    metric('对手平均胜率', a.strength_analysis?.opponent_avg_win_rate, b.strength_analysis?.opponent_avg_win_rate, pct),
    ...
    metric('机器人生存', a.defense_analysis?.components?.unit_survival, b.defense_analysis?.components?.unit_survival, number),
    metric('前哨存活', a.defense_analysis?.components?.outpost_survival, b.defense_analysis?.components?.outpost_survival, number),
    metric('基地保护', a.defense_analysis?.components?.base_protection, b.defense_analysis?.components?.base_protection, number),
    metric('净伤害交换', a.defense_analysis?.components?.damage_exchange, b.defense_analysis?.components?.damage_exchange, number),
