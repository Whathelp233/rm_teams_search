...
const dataRevision = 'score-3.6.0'
...
<div class="shell">
  ...
  <main v-if="selected">
    ...
    <section class="panel">
      <div class="section-head"><h2>高维战术解析 3.6</h2><span>逐局净事实 · 条件校正 · 时间回测</span></div>
