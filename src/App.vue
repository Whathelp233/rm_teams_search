...
const dataRevision = 'score-4.0.0-role-data-1.1.0-replay-3.1.0-tournament-3.0.0-tactics-1.0.0'
...
const methodologySections = computed(() => {
  ...
  const byTab = {
    ...
    compare:[{ title:'胜率模型', items:['胜率按赛区分别滚动校准：东部同赛区加入 10% 赛程校正赛果，南部、北部与跨赛区使用纯六维。透明对手分和直接交手仅作背景。'] }],
  }
