...
const dataRevision = 'score-4.0.0-matchup-4.8.0-rank-stability-1.0.0-series-validation-1.2.0-role-data-1.1.0-replay-3.1.0-tournament-3.0.0-tactics-1.0.0'
...
const methodologySections = computed(() => {
  ...
  const byTab = {
    ...
    compare:[{ title:'胜率模型', items:['南部使用全国统一六维；东部同赛区加入 10% 对手校正赛果；北部将 1% 从空间推进转入资源与热控；跨赛区仍使用全国统一六维。透明对手分和直接交手只作背景。'] }],
  }
